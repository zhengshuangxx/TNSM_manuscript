...
class PPOAgent:
    ...
    def update(self, states, actions, powers, log_probs_old, returns, advantages, step, loss,
        ...
        if step % 50 == 0:
            torch.save(self.actor.state_dict(), 'model_actor_262.pth')
            torch.save(self.critic.state_dict(), 'model_critic_262.pth')
...
for episode in range(MAX_EPISODE):
    ...
    np.savetxt('reward_3e-5_262.txt', Reward)
    np.savetxt('reward1_3e-5_262.txt', Reward1)
    np.savetxt('reward2_3e-5_262.txt', Reward2)
    np.savetxt('reward3_3e-5_262.txt', Reward3)
    np.savetxt('reward4_3e-5_262.txt', Reward4)
